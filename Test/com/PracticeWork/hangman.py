...
a 'word' in it. Instead, I'll use option two which is a wordlist

This is all to learn to work with URL's, API's, translating XML
...
while play_again:
    ...
    if turn == 7:
        ...
        if play_more == "n":
            ...
            quit() #this runs if something other than y or n is used
